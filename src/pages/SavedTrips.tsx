...
import { Bookmark, Trash2, Calendar, Loader2, Sparkles, ArrowRight, Hotel, IndianRupee, MapPin } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-sand flex items-center justify-center px-4">
        ...
        <div className="text-center max-w-sm">
          ...
          <p className="text-ink-400 mb-6">Sign in to save itineraries and access them anytime.</p>
    ...
    <div className="min-h-screen bg-sand">
      <div className="bg-white border-b border-ink-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <h1 className="font-display font-extrabold text-ink-900 text-4xl sm:text-5xl tracking-tight">Saved trips</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl border border-ink-100">
            ...
            <p className="text-ink-400 text-sm mb-6">Generate a trip plan and hit Save to keep it here.</p>
            <Link to="/itinerary"
          ...
          <div className="space-y-4">
            {trips.map(trip => {
              ...
              return (
                <div key={trip.id} className="bg-white rounded-3xl border border-ink-100 shadow-soft p-6 hover:border-saffron/20 transition-all group">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-display text-lg font-extrabold text-ink-900 leading-snug">{trip.title}</h3>
